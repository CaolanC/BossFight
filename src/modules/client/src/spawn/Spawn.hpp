...
namespace spawn {
    ...
    static entt::entity god(entt::registry& r) {
        const auto e = r.create();
        r.emplace<component::camera>(e);
    ...
    static entt::entity triangle(entt::registry& r, xg::Guid mesh_reference, xg::Guid material_reference) {
        ...
        r.emplace<shared::component::position>(e, glm::vec3(0, 0, 0));
        r.emplace<shared::component::rotation>(e, glm::quat());
        r.emplace<shared::component::transform>(e, glm::mat4(1.0f));
        r.emplace<component::scale>(e, 1.0f);
        return e;
    }

    static entt::entity model(entt::registry& r, xg::Guid model_ref, xg::Guid program_ref, std::string model_path = "none", glm::vec3 pos = glm::vec3(0, 0, 0), float scale = 1.0f, glm::quat rot = glm::quat(), std::string object_id = "", std::string name = "") {
        if (object_id.empty()) {
        ...
        r.emplace<component::name>(e, name);
        r.emplace<component::mat_ref>(e, program_ref);
        r.emplace<component::model_path>(e, model_path);
        r.emplace<shared::component::position>(e, pos);
        r.emplace<shared::component::rotation>(e, rot);
        r.emplace<shared::component::transform>(e, glm::mat4(1.0f));
